...
/* auth/reset.password.twig */
class __TwigTemplate_837d89c02e4614ce4f96a7ad9c6fc5b5 extends Template
{
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("auth/layout.twig", "auth/reset.password.twig", 1);
...
";
    ...
    <div class=\"container py-5 h-100\">
            ...
            <div class=\"col-12 col-md-8 col-lg-6 col-xl-5\">
                <div class=\"card bg-light text-white\" style=\"border-radius: 1rem;\">
                    <div class=\"card-body p-5 text-center\">
                        <div class=\"mb-4\">
                            <h2
                                class=\"fw-bold mb-5 text-uppercase text-primary d-flex justify-content-center align-items-center\">
                                <img src=\"";
        // line 25
        ...
        yield "\" width=\"64\" height=\"64\"
                            ...
                            <form class=\"reset-password-form\" method=\"post\" action=\"/reset-password/";
        // line 29
        ...
        yield "\">
                                ...
                                <button class=\"btn btn-primary bg-gradient text-white btn-lg px-5 reset-password-btn\"
                                    type=\"button\">
                                    Update
                                </button>
                            </form>
...
";
    ...
    {
        return "auth/reset.password.twig";
    }
    ...
    {
        return array (  126 => 29,  119 => 25,  108 => 16,  101 => 15,  90 => 13,  83 => 10,  79 => 9,  72 => 8,  65 => 5,  61 => 4,  54 => 3,  43 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "auth/reset.password.twig", "/var/www/resources/views/auth/reset.password.twig");
    }
}
